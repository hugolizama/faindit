 ...
 */
ini_set('intl.default_locale', 'America/El_Salvador');
...
/*
 * hugo lizama
 * inicio: Para modelos y controladores singular y plural en espanol
 */
...
Inflector::rules('singular', [
  ...
  /*
   * fin: Para modelos y controladores singular y plural en espanol
   */
  
  
  Configure::write('mostrarPublicidad', 0);
  Configure::write('publicidadResultados', 1);
