...
<div class="container-fluid">
  <div class="container">
    <div class="row">
      <div class="col-xs-12"><h2 class="page-header"><?= __('Im&aacute;genes de ') ?> <?= $sucursal['nombre'] ?> <?= __('de') ?> <?= $sucursal['negocio']['nombre'] ?></h2></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-9 frm-sm">
        <?php echo $this->Form->create('Sucursal', ['class' => 'form-horizontal frm-sm']); ?>  
        <div class="row">
          <div class="col-xs-12">
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            ?>
            <?= __('A continuaci&oacute;n puede cargar las im&aacute;genes que aparecer&aacute;n en el perfil de su sucursal 
              junto con las cargadas en el perfil de su negocio.<br/>
              M&aacute;ximo '.$config['negocios_sucursal_cant_imagenes'].' im&aacute;genes de '.$img_peso.' cada una. 
              Si el tama&ntilde;o excede de '.
        ...
        <div id="div-sortable">
        <?php if(count($sucursal['imagenes'])>0): ?>
        <div class="row">
        ...
        <div   class="row" style="text-align: center;">
          ...
          <div id="menu-eliminar-img" class="col-xs-12 text-center">
            ...
            <button id="btn-eliminar-seleccionadas" type="submit" name="btnEliminarImagenes" class="btn btn-danger btn-sm" disabled="disabled">
        ...
        <div class="row">
          <div class="col-xs-12">
            <ul id="sortable">
              <?php foreach ($sucursal['imagenes'] as $img): ?>
...
<script>
  $(document).ready(function(){
    ...
    function guardarOrden(){
      ...
      $.ajax({
        url: '<?= \Cake\Routing\Router::url(['prefix'=>false,'controller'=>'Sucursales','action'=>'guardarOrdenImagenes']); ?>',
    ...
    function mostrarImagenes(){
      $.ajax({
        url: '<?= \Cake\Routing\Router::url(['prefix'=>false,'controller'=>'Sucursales','action'=>'mostrarImagenes',$negocio_id, $sucursal_id]); ?>',
        dataType: 'html',
        type: 'post'        
      }).done(function(data){ /*finalizo ejecucion*/
    ...
    $("#img_upload").uploadFile({
      url: "<?= \Cake\Routing\Router::url(['prefix'=>false,'controller'=>'Sucursales','action'=>'cargarImagenes',$negocio_id, $sucursal_id]) ?>",
      fileName: "file",
      returnType: "json",
      ...
      maxFileCount: <?php echo (isset($config['negocios_sucursal_cant_imagenes'])) ? $config['negocios_sucursal_cant_imagenes'] : 10; ?>, 
