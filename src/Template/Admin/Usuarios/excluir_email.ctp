...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12">
      <h3><?= __('Excluir direcciones de correo') ?></h3>       
    </div>
  </div>
  
  <div class="row">
    <div class="col-xs-12 text-justify">
      <?= __('La siguientes exclusiones evitar&aacute;n el registro y uso de estas cuentas en el sistema. El uso de * 
        indica un comod&iacute;n para generalizar una exclusi&oacute;n, ej.: *hotmail.com') ?>       
    </div>
  </div>
