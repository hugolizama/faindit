...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12">
      <h3><?= __('Usuarios suspendidos. (Total '.$countUsuarios.')') ?></h3>       
    </div>
  </div>    
  <?php
      ...
      <table class="table table-hover table-striped">
        <thead>
          <tr>
            ...
            <th>
              <?php
              echo $this->Paginator->sort('Usuarios.fecha_suspension', __('Fecha de suspensión'));
              ?>
            </th>
            <th>
              <?php
              echo $this->Paginator->sort('Usuarios.razon_suspension', __('Razón de suspensión'));
              ?>
            </th> 
            <th>
              <?php
              echo $this->Paginator->sort('Usuarios.fecha_termina_suspension', __('Fecha termina suspensión'));
              ?>
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            ...
            <td><?= $usuario->fechaSuspensionFormat ?></td>
            <td><?= $usuario->razon_suspension ?></td>
            <td>
              <div><?php echo $usuario->fechaTerminaSuspensionFormat ?></div>
              <div><?php echo $usuario->tiempoTerminaSuspension ?></div>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
