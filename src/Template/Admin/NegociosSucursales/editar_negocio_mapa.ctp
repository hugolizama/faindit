...
<div class="container-fluid">  
  <div class="row">
    ...
    ?>
    <div class="col-xs-12">
      <h3><?= __('Editar ubicaci&oacute;n de ') ?> <?= $negocio['nombre'] ?></h3>       
    </div>
  </div>  

  <div class="row">    
    <div class="col-xs-12">
      <?= $this->Form->create($negocio, ['class' => 'form-horizontal ']); ?>  
...
$(document).ready(function(){ 
  ...
  function getDepartamentos(pais_id, cambioSeleccion){
    $.ajax({
      ...
      <?php if(isset($data['sucursales'][0]['departamento_id']) || isset($negocio['sucursales'][0]['departamento_id'])): ?>
