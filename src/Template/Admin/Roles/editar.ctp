  ...
  <div class="form-group">
    <div class="col-md-6 col-lg-4">
      ...
      echo $this->Form->input('nombre', [
        ...
        'class' => 'form-control',
        'value' => (!empty($data)) ? $data['nombre'] : ((isset($rol['nombre'])) ? $rol['nombre'] : '')
      ]);
      ?>
    </div>	
  </div>  
  ...
  <div class="form-group">
    <div class="col-md-6 col-lg-4">
      ...
      echo $this->Form->input('descripcion', [
        ...
        'class' => 'form-control',
        'value' => (!empty($data)) ? $data['descripcion'] : ((isset($rol['descripcion'])) ? $rol['descripcion'] : '')
      ]);
      ?>
    </div>	
  </div> 
                ...
                <tr>
                  <td>                        
                    ...
                    echo $this->Form->input('permisos.'.$per_llave, array(
                      ...
                      'div'=>false,
                      'escape'=>false,
                      'checked' => (!empty($data)) ? $data['permisos'][$per_llave] : (isset($rol[$per_llave])) ? $rol[$per_llave] : 0
                    ));
                    ?>
                  </td>                  
