...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            deletelStr: "Eliminar",
            doneStr: "Finalizado",
            multiDragErrorStr: "Carga multiple no esta permitida.",
            extErrorStr: "no es permitido. Extensiones permitidas: ",
            sizeErrorStr: "no es permitido. Tama&ntilde;o m&aacute;ximo: ",
        ...
        this.hide();
        this.errorLog = $("<div id='upload_errors'></div>"); //Writing errors
