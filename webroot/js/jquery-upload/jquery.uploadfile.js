...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Arrastre y suelte los archivos</b></span>",
            uploadStr:"Cargar",
            abortStr: "Abortar",
            cancelStr: "Cancelar",
            deletelStr: "Eliminar",
            ...
            sizeErrorStr: "no es permitido. Tama&ntilde;o permitido de: ",
            uploadErrorStr: "Upload is not allowed",
            maxFileCountErrorStr: " no es permitido. M&aacute;ximo de archivos permitidos: ",
        ...
        this.errorLog = $("<div id='jupload-errors' style='color:red;'></div>"); //Writing errors
        this.responses = [];
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    //var dragDrop = $('<div class="' + s.dragDropContainerClass + '" style="vertical-align:top;"></div>').width(s.dragdropWidth); //hugo lizama
	   ...
	   this.startUpload = function () {
		...
		function defaultProgressBar(obj,s)
		{
			...
			//this.statusbar = $("<div class='ajax-file-upload-statusbar'></div>").width(s.statusBarWidth); //hugo lizama
